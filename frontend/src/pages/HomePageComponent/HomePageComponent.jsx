...
<div className="ComponentContainer">
  ...
  <div className="HomePageBackgroundImgContainer" style={{ backgroundImage: `url("/img/notebook.jpg")` }}>
    ...
    <div className="homePageContactButton">
      <button>Kontakta mig idag för mer info och tidsbokning</button>
    </div>
  </div>
  ...
  <div className="HomePageServices">
    ...
    <button className="m30px">Kontakt och mer info</button>

    <div className="DyslexiaImgContainer">
      <img src="/img/personsittingatcomputer.jpg" alt="Site Logo" className="logo" />
    </div>
    <div className="DyslexiaPrice">
    ...
    <button>Kontakt och mer info</button>
